...
class RouterPolicyTests(unittest.TestCase):
    ...
    def test_file_url_rejects_non_local_provider_allowlist(self):
        ...
        with self.assertRaisesRegex(ValueError, "No Super Browser provider satisfies"):
            build_plan(task)
    ...
    def test_desktop_prefers_orgo(self):
        old_key = os.environ.pop("ORGO_API_KEY", None)
        old_id = os.environ.pop("ORGO_COMPUTER_ID", None)
        try:
