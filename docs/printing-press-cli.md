...
Super Browser already ships a **Python CLI** (`super-browser`) and **MCP server** inside the plugin bundle. Agents installed via `install-skill` or the Claude/Codex plugin get this surface automatically.
