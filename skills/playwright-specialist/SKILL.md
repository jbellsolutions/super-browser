...
Use screenshots, traces, DOM snapshots, and fixture tests. Prefer Playwright for the Super Browser test suite even when production uses a cloud provider.
