...
description: Verify Super Browser plans and runs. Use when an agent needs to test browser automation outputs, inspect run artifacts, check provider traces, validate external write guardrails, identify bugs or holes, and produce a confidence-rated run report.
---
