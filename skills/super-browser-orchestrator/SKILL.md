...
description: Orchestrate universal browser and computer automation with Super Browser. Use when an agent needs to receive a browser/computer task, classify risk, call the planner and provider specialists, request exact missing setup, dispatch execution through the Super Browser CLI or MCP server, and verify the final result.
---
...
6. Dispatch execution only after approval requirements are satisfied.
