...
description: Review Super Browser external-write actions. Use when a browser/computer workflow may post, comment, send messages, submit forms, upload files, change accounts, make purchases, use credentials, or perform destructive actions.
---
